...
typedef struct MarkovNode{
    ...
    int frequency_list_size; // total number of following words
    // any other field you need
} MarkovNode;

typedef struct MarkovNodeFrequency{
    struct MarkovNode* markov_node;
    int frequency; // the number of times this word appears after the previous node
    // any other fields you need
} MarkovNodeFrequency;

// function to initialize the markov chain
